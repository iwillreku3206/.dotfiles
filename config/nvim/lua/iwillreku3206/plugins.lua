...
local markdown_preview_server_plugin = vim.env["HOME"] .. "/Coding/nvim/markdown-preview-server.nvim"
local websocket_plugin = vim.env["HOME"] .. "/Coding/nvim/websocket.nvim"
require("lazy").setup({
	-- testing
	{
		dir = markdown_preview_server_plugin,
		config = function()
